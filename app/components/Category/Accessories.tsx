    ...
    useEffect(() => {
        const fetchMaterials = async () => {
            try {
                ...
                const accessories = data.filter((item: Material) =>
                    item.category?.name?.toLowerCase() === 'accessories'
                );

                setMaterials(accessories);
                setFilteredMaterials(accessories);
            } catch (error) {
            ...
            <div className="relative bg-[#1A1A1A] text-white py-20 px-4 mb-12">
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <p className="text-gray-400 max-w-2xl text-lg font-light">
                        Elevate your style with our exclusive range of accessories.
                        Subtle details that make a bold statement.
                    </p>
                </div>
